  ...
  return (
    <>
      <div className="main min-h-screen bg-background md:pb-[160px]">
        ...
        <div className="mt-12 ml-6 mr-6 bg-white rounded-[10px] font-bold pb-6 md:rounded-[20px] md:pb-[56px] md:pl-[56px] md:pr-[56px] md:mt-[78px] md:mr-[56px] md:ml-[56px]">
          ...
          <div className="flex align-center justify-center m-6 mt-4 gap-3 md:mb-[33px] md:ml-0 md:gap-[30px]">
            <div
              className={`rounded-[26px]  w-[50%] md:rounded-[36px] ${
          ...
          <div className="flex align-center justify-center m-6 mt-4 gap-2 md:gap-[22px] md:ml-0 md:mb-[33px] ">
            <div
              className={`rounded-[26px]  w-[25%] md:rounded-[36px] ${
          ...
          <Link to={{ pathname: gamePagePath }} state={{ settings }}>
            <div className="min-w-screen bg-yellow rounded-[26px] md:rounded-[35px] ml-6 mr-6 md:ml-0">
